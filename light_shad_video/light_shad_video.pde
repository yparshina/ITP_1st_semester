/*
This program needs a web cam to run.

The video feed is analyzed for each pixel's luminance value.
The darker pixels reveal more of the "shadow" image while 
the lighter pixels revleal more of the "light" image.
*/
